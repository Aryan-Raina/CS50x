...
function Player:touchedFlag()
    if self.map:tileAt(self.x , self.y).id == 13 or
     self.map:tileAt(self.x, self.y + self.height).id == 13 or
     self.map:tileAt(self.x + self.width, self.y).id == 13 or
     self.map:tileAt(self.x + self.width, self.y + self.height).id == 13 then
        return true
    end
